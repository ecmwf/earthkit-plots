...
from earthkit.plots.core.extractors import extract_plottables_2D, extract_plottables_3D, configure_style
    ...
    def decorator(method):
        def wrapper(
            ...
            **kwargs,
            ...
            u_source, v_source = _extract_vector_sources(
                args, x, y, u, v, source_units
            )
