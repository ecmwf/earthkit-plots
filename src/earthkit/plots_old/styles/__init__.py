...
from earthkit.plots.styles import magics_colors_to_rgb
    ...
    def to_quantiles_kwargs(self, n, c=None):
        ...
        if isinstance(c, str):
            ...
            if c in mpl.colormaps:
                ...
                c = styles.symmetric_from_color(c, n)
    ...
    **kwargs
    ...
    def contourf(self, *args, **kwargs):
        ...
        **kwargs
        ...
        linecolors = styles.expand(self._foreground_colors, mappable.levels)
    ...
    def colorbar(self, *args, **kwargs):
        ...
        **kwargs
        ...
        linecolors = styles.expand(self._foreground_colors, levels)
    ...
    def disjoint(self, layer, *args, **kwargs):
        ...
        **kwargs
        ...
        linecolors = styles.expand(self._foreground_colors, layer.mappable.levels)
